...
- Made rendered visuals authoritative before claim locking. The deterministic renderer now replaces model-guessed image blocks in the draft with the manifest's exact public SVG paths and captions, and publication rendering removes those Markdown blocks before inserting one hash-bound accessible figure, preventing both broken placeholder assets and duplicate diagrams.
