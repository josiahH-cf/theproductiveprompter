...
Research + brief
  ↓
Draft
  ↺  repair failed evidence or voice checks
...
This article is moving through that process now. It began as a sparse seed, accumulated research and owner decisions, received a brief, and entered drafting only after the intent was confirmed. It is not published merely because this draft exists. The publication loop still has to package it, deploy it, inspect it, and return evidence.
